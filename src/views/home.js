      ...
      <main className="home-main">
            ...
            <div className="home-heading-container1">
              ...
              <button className="home-primary1 button-primary button-lg button">
                <span>
                  ...
                  <span></span>
                  <br></br>
                  <span>Scroll down to find more</span>
                </span>
              </button>
            </div>
        ...
        <div className="home-portofolio section-container">
          <div className="home-max-width02 max-content-container">
            <div className="home-text-container">
              <span className="home-text023">PROOF OF CONCEPT</span>
              <h2 className="home-text024 heading2">
            ...
            <div className="home-tab-selector-header">
              <span className="home-text041 tab-selector-btn">
                New World Who Dis?
              </span>
              <span className="home-text042 tab-selector-btn">Knot Knot</span>
              <span className="home-text043 tab-selector-btn">Burgeroober</span>
              <span className="home-text044 tab-selector-btn">Carpet diem</span>
              <span className="home-text045 tab-selector-btn">
                Final Showdown
              </span>
        ...
        <div className="home-about section-container">
          <div className="home-max-width03 max-content-container">
            <div className="home-text-container1">
              <span className="home-text047">about FuNDs</span>
              <h2 className="home-text048 heading2">
              ...
              <div className="home-checklist">
                ...
                <div className="home-check-item2">
                  ...
                  <span className="home-text053">9% to marketing</span>
                </div>
                <div className="home-check-item3">
                  <svg viewBox="0 0 1024 1024" className="home-icon06">
                    <path d="M384 690l452-452 60 60-512 512-238-238 60-60z"></path>
                  </svg>
                  <span className="home-text054">10% to trading</span>
                </div>
                <div className="home-check-item4">
                  <svg viewBox="0 0 1024 1024" className="home-icon08">
                    <path d="M384 690l452-452 60 60-512 512-238-238 60-60z"></path>
                  </svg>
                  <span className="home-text055">21% to team</span>
                </div>
        ...
        <div className="home-process section-container">
          <div className="home-max-width04 max-content-container">
            <span className="home-text057">Rarity Chairs</span>
            <h2 className="home-text058 heading2">
              <span>
            ...
            <div className="home-step">
              <span className="home-text062">01</span>
              <img
                alt="image"
              ...
              <div className="home-container43">
                ...
                <span className="home-text064">
                  Blue Chairs will be the first to add one liners to the plot
                </span>
              </div>
            </div>
            <div className="home-step1">
              <span className="home-text065">02</span>
              <img
                alt="image"
              ...
              <div className="home-container44">
                ...
                <span className="home-text067">
                  Yolo the entire ether on usdd futures to solana puts
                </span>
              </div>
            </div>
            <div className="home-step2">
              <span className="home-text068">03</span>
              <img
                alt="image"
              ...
              <div className="home-container45">
                ...
                <span className="home-text070">
                  Suggest the locations, digital real estate to be
                  <span
                    dangerouslySetInnerHTML={{
                      __html: ' ',
                    }}
          ...
          <div className="home-max-width05 max-content-container">
            <div className="home-step3">
              <span className="home-text071">04</span>
              <img
                alt="image"
              ...
              <div className="home-container46">
                ...
                <span className="home-text073">
                  Add custom traits to your 3d avatar
                </span>
              </div>
            </div>
            <div className="home-step4">
              <span className="home-text074">05</span>
              <img
                alt="image"
              ...
              <div className="home-container47">
                ...
                <span className="home-text076">
                  Invite a friend for free to play a character in the movie
                </span>
              </div>
            </div>
            <div className="home-step5">
              <span className="home-text077">06</span>
              <img
                alt="image"
              ...
              <div className="home-container48">
                ...
                <span className="home-text079">
                  o thEpic rarity &amp; a pass to add cinematic shots te final
                  part of the movie
                </span>
              </div>
            </div>
          ...
          <div className="home-max-width06 max-content-container">
            <div className="home-step6">
              <span className="home-text080">07</span>
              ...
              <div className="home-container49">
                <span className="home-text081">Finale</span>
                <span className="home-text082">
                  These few epicest of chairs utility will be revealed post mint
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="home-blog section-container">
          <div className="home-max-width07 max-content-container">
            <h2 className="home-text083 heading2">
            ...
            <span className="home-text085">
              ...
              <span className="home-text087">Mystery of the Missing Moon</span>
              <span>
                {' '}
        ...
        <div className="home-blog1 section-container">
          <div className="home-max-width08 max-content-container">
            <h2 className="home-text106 heading2">
              <span>TEAM</span>
            </h2>
            <span className="home-text108">
              <span>
                3 time zones, 1 aim - to create the most epic collab DeFi movie
                using decentralized assets
              </span>
            </span>
        ...
        <div className="home-banner section-container">
          <div className="home-max-width09 max-content-container">
            <span className="home-text140">Become a piece of history</span>
            <h2 className="home-text141 heading2">
      ...
      <div className="home-about1 section-container">
        <div className="home-max-width10 max-content-container">
          <div className="home-text-container2">
            <h2 className="home-text145 heading2">
